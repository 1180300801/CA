...
<head>
    ...
    <script>
        window.onload = function () {
            document.getElementById("download_check_img").onclick = function () {
...
<div class="container" style="width: 40%;">
    <form action="/tw/downloadCerServlet" method="post">
        ...
        <input type="password" name="check_code" placeholder="验证码" required="" style="width: 40%">
        <img src="/tw/checkCodeServlet" id="download_check_img" style="float: left">
